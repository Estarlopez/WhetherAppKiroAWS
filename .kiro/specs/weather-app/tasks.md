...
- [x] 1. Create the HTML shell and basic CSS layout
...
- [x] 2. Implement city geocoding and NWS points lookup
...
- [x] 3. Implement forecast fetch and render current conditions
...
- [x] 4. Render the 5-day forecast table
...
- [x] 5. Polish UI, error handling, and open prototype in browser
